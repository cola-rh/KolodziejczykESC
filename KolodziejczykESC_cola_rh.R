setwd("/omics/groups/OE0246/internal/guz/cola_hc/examples/KolodziejczykESC")
library(cola)
...
library(scRNAseq)
data = readRDS('/omics/groups/OE0246/internal/guz/cola_hc/examples/KolodziejczykESC/KolodziejczykESC_data.rds')
